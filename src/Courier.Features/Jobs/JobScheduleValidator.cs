...
public class CreateJobScheduleValidator : AbstractValidator<CreateJobScheduleRequest>
{
    public CreateJobScheduleValidator()
    {
...
public class UpdateJobScheduleValidator : AbstractValidator<UpdateJobScheduleRequest>
{
